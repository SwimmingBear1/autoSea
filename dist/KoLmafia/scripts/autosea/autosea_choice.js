...
// src/standalone/autosea_choice.ts
var autosea_choice_exports = {};
__export(autosea_choice_exports, {
  main: function() {
    return main;
  },
  runPeridotChoice: function() {
    return runPeridotChoice;
  }
});
module.exports = __toCommonJS(autosea_choice_exports);
...
var holidayWanderers = /* @__PURE__ */ new Map([["El Dia De Los Muertos Borrachos", $monsters(_templateObject1 || (_templateObject1 = _taggedTemplateLiteralLoose(["Novia Cad\xE1ver, Novio Cad\xE1ver, Padre Cad\xE1ver, Persona Inocente Cad\xE1ver"])))], ["Feast of Boris", $monsters(_templateObject10 || (_templateObject10 = _taggedTemplateLiteralLoose(["Candied Yam Golem, Malevolent Tofurkey, Possessed Can of Cranberry Sauce, Stuffing Golem"])))], ["Talk Like a Pirate Day", $monsters(_templateObject11 || (_templateObject11 = _taggedTemplateLiteralLoose(["ambulatory pirate, migratory pirate, peripatetic pirate"])))]]);
var telescopeStats = /* @__PURE__ */ new Map([["standing around flexing their muscles and using grip exercisers", $stat(_templateObject12 || (_templateObject12 = _taggedTemplateLiteralLoose(["Muscle"])))], ["sitting around playing chess and solving complicated-looking logic puzzles", $stat(_templateObject13 || (_templateObject13 = _taggedTemplateLiteralLoose(["Mysticality"])))], ["all wearing sunglasses and dancing", $stat(_templateObject14 || (_templateObject14 = _taggedTemplateLiteralLoose(["Moxie"])))]]);
var telescopeElements = /* @__PURE__ */ new Map([["people, all of whom appear to be on fire", $element(_templateObject15 || (_templateObject15 = _taggedTemplateLiteralLoose(["hot"])))], ["people, surrounded by a cloud of eldritch mist", $element(_templateObject16 || (_templateObject16 = _taggedTemplateLiteralLoose(["spooky"])))], ["greasy-looking people furtively skulking around", $element(_templateObject17 || (_templateObject17 = _taggedTemplateLiteralLoose(["sleaze"])))], ["people, surrounded by garbage and clouds of flies", $element(_templateObject18 || (_templateObject18 = _taggedTemplateLiteralLoose(["stench"])))], ["people, clustered around a group of igloos", $element(_templateObject19 || (_templateObject19 = _taggedTemplateLiteralLoose(["cold"])))]]);
var hedgeTrap1 = /* @__PURE__ */ new Map([["smoldering bushes on the outskirts of a hedge maze", $element(_templateObject20 || (_templateObject20 = _taggedTemplateLiteralLoose(["hot"])))], ["creepy-looking black bushes on the outskirts of a hedge maze", $element(_templateObject21 || (_templateObject21 = _taggedTemplateLiteralLoose(["spooky"])))], ["purplish, greasy-looking hedges", $element(_templateObject22 || (_templateObject22 = _taggedTemplateLiteralLoose(["sleaze"])))], ["nasty-looking, dripping green bushes on the outskirts of a hedge maze", $element(_templateObject23 || (_templateObject23 = _taggedTemplateLiteralLoose(["stench"])))], ["frost-rimed bushes on the outskirts of a hedge maze", $element(_templateObject24 || (_templateObject24 = _taggedTemplateLiteralLoose(["cold"])))]]);
var hedgeTrap2 = /* @__PURE__ */ new Map([["smoke rising from deeper within the maze", $element(_templateObject25 || (_templateObject25 = _taggedTemplateLiteralLoose(["hot"])))], ["a miasma of eldritch vapors rising from deeper within the maze", $element(_templateObject26 || (_templateObject26 = _taggedTemplateLiteralLoose(["spooky"])))], ["a greasy purple cloud hanging over the center of the maze", $element(_templateObject27 || (_templateObject27 = _taggedTemplateLiteralLoose(["sleaze"])))], ["a cloud of green gas hovering over the maze", $element(_templateObject28 || (_templateObject28 = _taggedTemplateLiteralLoose(["stench"])))], ["wintry mists rising from deeper within the maze", $element(_templateObject29 || (_templateObject29 = _taggedTemplateLiteralLoose(["cold"])))]]);
var hedgeTrap3 = /* @__PURE__ */ new Map([["with lava slowly oozing out of it", $element(_templateObject30 || (_templateObject30 = _taggedTemplateLiteralLoose(["hot"])))], ["surrounded by creepy black mist", $element(_templateObject31 || (_templateObject31 = _taggedTemplateLiteralLoose(["spooky"])))], ["that occasionally vomits out a greasy ball of hair", $element(_templateObject32 || (_templateObject32 = _taggedTemplateLiteralLoose(["sleaze"])))], ["disgorging a really surprising amount of sewage", $element(_templateObject33 || (_templateObject33 = _taggedTemplateLiteralLoose(["stench"])))], ["occasionally disgorging a bunch of ice cubes", $element(_templateObject34 || (_templateObject34 = _taggedTemplateLiteralLoose(["cold"])))]]);
...
function makeScalerCalcFunction(cache, pattern) {
  return function(monster) {
    ...
    return (0, import_kolmafia3.monsterEval)(result);
  };
}
...
var bulkAutosell = makeBulkFunction(import_kolmafia3.autosell);
var bulkPutCloset = makeBulkFunction(import_kolmafia3.putCloset);
var bulkPutDisplay = makeBulkFunction(import_kolmafia3.putDisplay);
var bulkPutStash = makeBulkFunction(import_kolmafia3.putStash);
var bulkTakeCloset = makeBulkFunction(import_kolmafia3.takeCloset);
var bulkTakeDisplay = makeBulkFunction(import_kolmafia3.takeDisplay);
var bulkTakeShop = makeBulkFunction(import_kolmafia3.takeShop);
var bulkTakeStash = makeBulkFunction(import_kolmafia3.takeStash);
var bulkTakeStorage = makeBulkFunction(import_kolmafia3.takeStorage);
...
var SPECIAL_ULTS = /* @__PURE__ */ new Map([[$familiar(_templateObject47 || (_templateObject47 = _taggedTemplateLiteralLoose(["Nursine"]))), ["ult_bearhug"]], [$familiar(_templateObject48 || (_templateObject48 = _taggedTemplateLiteralLoose(["Caramel"]))), ["ult_sticktreats"]], [$familiar(_templateObject49 || (_templateObject49 = _taggedTemplateLiteralLoose(["Smashmoth"]))), ["ult_owlstare"]], [$familiar(_templateObject50 || (_templateObject50 = _taggedTemplateLiteralLoose(["Slotter"]))), ["ult_bloodbath"]], [$familiar(_templateObject51 || (_templateObject51 = _taggedTemplateLiteralLoose(["Cornbeefadon"]))), ["ult_pepperscorn"]], [$familiar(_templateObject52 || (_templateObject52 = _taggedTemplateLiteralLoose(["Mu"]))), ["ult_rainbowstorm"]]]);
...
function main(choice, pageText) {
  var options = (0, import_kolmafia4.availableChoiceOptions)();
  if (choice === 1525) {
    var priority = {
    ...
    for (var _i = 0, _Object$entries = Object.entries(options); _i < _Object$entries.length; _i++) {
      var _Object$entries$_i = _slicedToArray3(_Object$entries[_i], 2), option = _Object$entries$_i[0], optionText = _Object$entries$_i[1];
      if (!priority[optionText]) {
        (0, import_kolmafia4.print)('dart perk "' + optionText + '" not in priority list', "red");
        continue;
      }
    ...
    (0, import_kolmafia4.runChoice)(choiceToRun);
  } else if (choice >= 48 && choice <= 61) {
    (0, import_kolmafia4.abort)();
  } else if (choice == 312) {
    (0, import_kolmafia4.runChoice)(3);
  } else if (choice == 315) {
    var encounters = get("_autosea_outpost_choices", 0) + 1;
    _set("_autosea_outpost_choices", encounters);
    (0, import_kolmafia4.runChoice)(encounters);
  } else if (choice == 1562) {
    var getPriority = function(option2) {
      return MOBIUS_PRIORITIES[option2];
    };
    var bestChoice = Object.entries(options).reduce(function(a, b) {
      return getPriority(a[1]) <= getPriority(b[1]) ? a : b;
    })[0];
    (0, import_kolmafia4.runChoice)(Number(bestChoice));
  } else if (choice == 1557) {
    runPeridotChoice(pageText);
  } else if (choice == 704) {
    (0, import_kolmafia4.print)(pageText);
    var libraryOptions = get("merkinCatalogChoices").split(",");
    var _iterator = _createForOfIteratorHelper3(libraryOptions), _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
        var _option = _step.value;
        var _option$split = _option.split(":"), _option$split2 = _slicedToArray3(_option$split, 3), _ = _option$split2[0], choiceNum = _option$split2[1], status = _option$split2[2];
        if (status === "unknown") {
          (0, import_kolmafia4.runChoice)(parseInt(choiceNum));
          return;
        }
      }
    } catch (err) {
    ...
    var bestGuess = getDreadscrollGuess();
    var extra = "pro1=" + bestGuess[0] + "&pro2=" + bestGuess[1] + "&pro3=" + bestGuess[2] + "&pro4=" + bestGuess[3] + "&pro5=" + bestGuess[4] + "&pro6=" + bestGuess[5] + "&pro7=" + bestGuess[6] + "&pro8=" + bestGuess[7];
    (0, import_kolmafia4.runChoice)(1, extra);
  } else if (choice == 310) {
    if (have($item(_templateObject || (_templateObject = _taggedTemplateLiteralLoose2(["rough fish scale"]))), 10)) {
      (0, import_kolmafia4.runChoice)(2);
    } else {
      (0, import_kolmafia4.runChoice)(6);
    }
  }
}
function getDreadscrollGuess() {
  var possibleCodes = [""];
  for (var i = 1; i <= 8; i++) {
    var currentClue = get("dreadScroll" + i, 0);
    if (currentClue !== 0) {
      for (var j = 0; j < possibleCodes.length; j++) {
        possibleCodes[j] = possibleCodes[j] + currentClue;
      }
    } else {
      var newCodes = [];
      var _iterator2 = _createForOfIteratorHelper3(possibleCodes), _step2;
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
  ...
  var pastGuesses = get("dreadScrollGuesses");
  if (pastGuesses) {
    var guesses = pastGuesses.split(",");
    var _iterator3 = _createForOfIteratorHelper3(guesses), _step3;
    try {
      var _loop = function _loop2() {
        var guess = _step3.value;
        var _guess$split = guess.split(":"), _guess$split2 = _slicedToArray3(_guess$split, 2), code2 = _guess$split2[0], incorrectStr = _guess$split2[1];
        var incorrectCount = parseInt(incorrectStr);
        possibleCodes = possibleCodes.filter(function(candidate2) {
          var differences = 0;
          for (var _i2 = 0; _i2 < 8; _i2++) {
            if (candidate2[_i2] !== code2[_i2]) {
              differences++;
            }
          }
  ...
  var bestCode = possibleCodes[0];
  var minExpectedErrors = 8;
  var _iterator4 = _createForOfIteratorHelper3(possibleCodes), _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
      var candidate = _step4.value;
      var expectedErrors = 0;
      for (var pos = 0; pos < 8; pos++) {
        var candidateDigit = candidate[pos];
        var matchCount = 0;
        var _iterator5 = _createForOfIteratorHelper3(possibleCodes), _step5;
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
            var possible = _step5.value;
        ...
        var errorProb = 1 - matchCount / possibleCodes.length;
  ...
  (0, import_kolmafia4.print)("Possible codes: " + possibleCodes);
  (0, import_kolmafia4.print)("Best guess: " + bestCode);
  return bestCode;
}
...
var MOBIUS_PRIORITIES = {
  "I'm not messing with the timeline!": 100,
  "Borrow a cup of sugar from yourself": 99,
  "Return the sugar you borrowed": 1e3,
  "Draw a goatee on yourself": 1e3,
  "Succumb to evil": 1e3,
  "Make friends with a famous poet": 1e3,
  "Make enemies with a famous poet": 1e3,
  "Go back and take a 20-year-long nap": 10,
  "Go back and set an alarm": 31,
  "Go for a nature walk": 1e3,
  "Go back in time and kill a butterfly": 1e3,
  "Cheeze it, it's the pigs!": 1e3,
  "Aiding and abetterment": 1e3,
  "Plant some trees and harvest them in the future": 20,
  "Teach hippies to make jams and jellies": 1e3,
  "Plant some seeds in the distant past": 1e3,
  "Chop down some trees": 1e3,
  "Play Schroedinger's Prank on yourself": 1e3,
  "Check your pocket": 1e3,
  "Steal a club from the past": 1e3,
  "Prevent the deadly seal invasion": 1e3,
  "Borrow meat from your future": 8,
  "Repay yourself in the past": 1e3,
  "Mind your own business": 1e3,
  "Sit and write in your journal": 1e3,
  "Take the long odds on the trifecta": 1e3,
  "Fix the race and also fix the race.": 1e3,
  "Go back and write a best-seller.": 5,
  "Replace your novel with AI drivel": 6,
  "Lift yourself up by your bootstraps": 1e3,
  "Let yourself get lifted up by your bootstraps": 1e3,
  "Shoot yourself in the foot": 1e3,
  "Get shot in the foot": 1e3,
  "Give your past self investment tips": 1e3,
  "Steal from your future self": 1e3,
  "Peek in on your future": 1e3,
  "Make yourself forget": 1e3,
  "Defend yourself": 1e3,
  "Assassinate yourself": 1e3,
  ...
  "Bake Susie a cupcake": 1e3,
  "Hey, free gun!": 1e3,
  "Sell the gun": 1e3,
  "Meet your parents when they were young": 1e3,
  "Fix your parents' relationship": 1e3
};
function getChoiceOption() {
  var option = get("choiceAdventure1557");
  if (typeof option === "number") return [option, null];
  var _option$split3 = option.split("&", 2), _option$split4 = _slicedToArray3(_option$split3, 2), value = _option$split4[0], addendums = _option$split4[1];
  return [Number(value), addendums];
}
function runPeridotChoice(pageText) {
  var _getChoiceOption = getChoiceOption(), _getChoiceOption2 = _slicedToArray3(_getChoiceOption, 2), option = _getChoiceOption2[0], addendums = _getChoiceOption2[1];
  if (!addendums) return void (0, import_kolmafia4.runChoice)(option);
  if (!addendums.startsWith("bandersnatch=")) {
    (0, import_kolmafia4.abort)("Invalid peridot args: " + addendums);
  }
  var monsterId = addendums.slice("bandersnatch=".length);
  if (!(0, import_kolmafia4.xpath)(pageText, "//form//input[@name='bandersnatch'][@value='" + monsterId + "']").length) {
    return void (0, import_kolmafia4.runChoice)(2);
  }
  return void (0, import_kolmafia4.runChoice)(option, addendums);
}
