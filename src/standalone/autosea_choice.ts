import {abort, availableChoiceOptions, getProperty, print, runChoice, xpath} from "kolmafia";
import {$item, get, have, NumericOrStringProperty, set, ValueOf} from "libram";

export function main(choice: number, pageText: string) {
    ...
    if (choice === 1525) {
        ...
        let encounters = get("_autosea_outpost_choices", 0) + 1;
        set("_autosea_outpost_choices", encounters);
